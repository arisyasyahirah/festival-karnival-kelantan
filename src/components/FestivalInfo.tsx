      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-6 py-8 md:grid-cols-2 md:gap-16">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-6 text-sm leading-relaxed text-ink/80 md:text-base">
            {lang === "ms"
              ? "Festival Lensa Pendidikan Kelantan (FleP26) merupakan festival pendidikan digital bertaraf antarabangsa, dianjurkan oleh Sektor Sumber dan Teknologi Pendidikan (SSTP) dengan kerjasama Universiti Malaysia Kelantan (UMK). Menghimpunkan bakat murid dari Malaysia, Indonesia, Brunei dan pelbagai negara dalam bidang perfileman, video kreatif dan podcast."
              : "The Kelantan Education Lens Festival (FleP26) is an international-level digital education festival, organised by the Education Resource and Technology Sector (SSTP) in collaboration with Universiti Malaysia Kelantan (UMK). It brings together student talent from Malaysia, Indonesia, Brunei and other countries in filmmaking, creative video, and podcasting."}
          </p>
